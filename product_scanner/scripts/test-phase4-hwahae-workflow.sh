...
echo ""
echo "⚠️  화해는 API 기반이므로 gentle rate limiting 적용됨"
echo ""
...
{
  "workflow_id": "phase4-hwahae-validation-v1",
  "priority": 5,
  "params": {
    "platform": "hwahae",
  ...
  "metadata": {
    "test": true,
    "phase": "4",
    "description": "Phase 4 화해 API 기반 검증 테스트 (Gentle Rate Limiting)"
  }
}
EOF
)
